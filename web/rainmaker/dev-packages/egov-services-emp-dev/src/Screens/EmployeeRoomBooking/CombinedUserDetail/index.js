          ...
          textChildren={
            <div>
              <div className="rainmaker-displayInline">
                ...
                <Label label="BK_MYBK_COMMUNITY_CENTER_ROOM_USER_DETAILS" containerStyle={{ marginLeft: "13px" }} labelClassName="dark-heading" />
              </div>
              ...
              <div className="col-md-4">
                            ...
                            <div className="col-md-4">
                                <Label className="col-xs-12  col-sm-12 col-md-12 status-color" label="BK_MYBK_CC_ROOM_EMAIL" />
                                <Label
                                    className="col-xs-12  col-sm-12 col-md-12  status-result-color"
                                    id="complaint-details-current-status"
                                    labelStyle={{ color: "inherit" }}
