...
class CGBookingDetails extends Component {
  ...
  callApiForDocumentData = async (e) => {
    const { documentMap, userInfo, docType, docData } = this.props;
    console.log(this.props, "Nero Han")
    var documentsPreview = [];
    if (docType === "DISCOUNTPROOF") {
      if (docData && docData.discountDocumentsUploadRedux) {
        console.log(docData.discountDocumentsUploadRedux, "Nero docData.discountDocumentsUploadRedux")
        ...
        documentsPreview.push({
          title: docData.discountDocumentsUploadRedux[0].documentCode,
          fileStoreId: docData.discountDocumentsUploadRedux[0].documents[0].fileStoreId,
          linkText: "View",
        });
  ...
  render() {
    const { documentMap, uploadeDocType, docType, docData } = this.props;
            ...
            <div>
              <div className="rainmaker-displayInline">
                {docType != "DISCOUNTPROOF" ?
                  ...
                  <Label label="Discount documents" containerStyle={{ marginLeft: "13px" }} labelClassName="dark-heading" />
                }
              </div>
              <div key={10} className="complaint-detail-full-width">
                ...
                <div className="complaint-detail-detail-section-status row">
                  <div className="col-md-4">
                    {uploadeDocType !== "NotFound" && docType != "DISCOUNTPROOF" ?
                      <Label
                    ...
                    {docType == "DISCOUNTPROOF" ?
                      <Label
                        ...
                        id="complaint-details-current-status"
                        labelStyle={{ color: "inherit" }}
                        label={docData && docData.discountDocumentsUploadRedux && docData.discountDocumentsUploadRedux[0].documents[0].fileName}
                      />
                      :
                      <Label
                        className="col-xs-12  col-sm-12 col-md-12  status-result-color"
